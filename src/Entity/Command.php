...
class Command
{
    ...
    public function getPriceSending(): ?float
    {
        return $this->priceSending;
    }

    public function setPriceSending(?float $priceSending): self
    {
    ...
    public function getTotal()
    {
        ...
        foreach($this->getCommandDetails()->getValues() as $product)
        {
